...
namespace Alphtmost.Servicios.Interfaz
{
    ...
    {
        Task<Administrador> ObtenerUsuarioPorEmailAsync(string email);  // Obtener usuario por email
        ...
        Task<string> GenerarTokenJwtAsync(Administrador admin);  // Generar token JWT
    }
}
